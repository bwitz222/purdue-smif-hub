...
const BIO_BY_NAME: Record<string, string> = {
  ...
  "Anushka Patel": "Anushka Patel is a sophomore in the Daniels School of Business at Purdue University, pursuing a B.S. in Quantitative Business Economics and a B.A. in Global Studies with a certification in Data Science. She currently serves as a Risk Management Analyst with the Student Managed Investment Fund and as a Senior Consultant with 180 Degrees Consulting. Outside of academics, she enjoys art, vintage and thrifted fashion, and public speaking.",
