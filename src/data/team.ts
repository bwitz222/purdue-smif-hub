...
const BIO_BY_NAME: Record<string, string> = {
  "Landon Haffner":
    "Landon Haffner is a sophomore in the Daniels School of Business, majoring in Finance with a minor in Real Estate Finance, Management Consulting and Entrepreneurship. He is interning at Lennar this summer in sales and land acquisition. In his free time, he enjoys going to the gym, golfing and playing rocket league with friends.",
  "Yashita Pujari":
    "Yashita Pujari is a junior in the Daniels School of Business, majoring in Business Analytics and Information Management. Outside of SMIF, she serves on the executive board of UR Global and will be a team lead for the Doster Leadership Conference. In her free time, she enjoys baking, reading and trying new restaurants.",
  "Chris Andreou":
    "Chris Andreou is a junior in the Daniels School of Business, majoring in Finance and Accounting. He has previously interned at Zurich Insurance as a Finance Intern. In his free time, he enjoys visiting new countries, weightlifting, playing basketball, and golfing.",
  "Parth Dama":
    "Parth Dama is a sophomore in the Purdue Integrated Business and Engineering (IBE) program. He is currently working as an Associate Consultant Intern at IBM in Data & AI, and is an incoming Markets Quantitative Analyst at Barclays for Summer 2027. In his free time, he enjoys lifting, playing poker, and watching basketball.",
  "Andrew Lacambra":
    "Andrew Lacambra is a senior in the Daniels School of Business, majoring in Finance and General Management. He previously interned at State Farm as a Fixed Income Investments Intern. In his free time, he enjoys visiting National Parks, going to the gym, and watching soccer & basketball.",
  "Ian Teh":
    "Ian Teh is a senior in the Daniels School of Business, majoring in Finance with a minor in Real Estate Finance. He has previously interned at CenterPoint Properties as a Capital Markets Summer Analyst. In his free time, he enjoys hiking, going to the gym, and cooking new cuisines.",
  "Mikhail Bilokin":
    "Michael Bilokin is a sophomore in the Daniels School of Business, majoring in Finance and Accounting. In his free time, he enjoys playing chess, poker, and following financial markets.",
  "Balthazar Schmitt":
    "Balthazar Schmitt is a junior majoring in Mathematics and Economics. He has previously interned at CBRE and Turner and Townsend, working within project management. Outside of classes and work, he enjoys taking long drives in the countryside, hiking mountains, skiing, and making music.",
  "Augustus Matushek":
    "Augustus Matushek is a sophomore in the Daniels School of Business, majoring in Finance and Accounting. Augie previously interned at Centier Bank, where he worked as a Business Planning & Analysis Intern. In his free time, he enjoys reading, going to the gym, and working on his golf game.",
  "Jacob George":
    "Jacob George is a sophomore in the Daniels School of Business, majoring in Finance and Business Analytics Information Management. Outside of SMIF, he is a Capital Markets Intern with Simon Property Group. In his free time, he enjoys going to the gym, DJing diverse styles of music, and all things Purdue sports.",
  "Dallas White":
    "Dallas White is a sophomore in the Daniels School of Business, majoring in Finance and Accounting with a minor in Business Economics. He is running KNA Autocare this summer, honing his entrepreneurial and sales skills. In his free time, he enjoys traveling, exercise, and listening to music.",
  "Keren Wadhwani":
    "Keren Wadhwani is a junior in the Daniels School of Business, majoring in Quantitative Economics and Finance with a minor in Art History. She previously interned at energyRe as an M&A and Investments Intern and is a Girls Who Invest Scholar. Outside of SMIF, she is a competitive triathlete with a passion for fine art. In her free time, she enjoys running, swimming, visiting museums, and painting.",
  "Logan Friedman":
    "Logan Friedman is a junior in the College of Engineering, majoring in Mechanical Engineering with a minor in Finance. He is currently working as a Mechanical Engineering Intern at Northrop Grumman. In his free time, he enjoys hiking, surfing, and pickleball.",
  "Sid Voona":
    "Siddharth Voona is a sophomore in the Daniels School of Business, majoring in Finance and Accounting. He has previously interned at MD Global Partners as an Investment Banking Analyst and is the President of Purdue's Banking and Markets Club. In his free time, he enjoys playing guitar, poker, and cooking.",
  "Evan Wright":
  ...
  "Shaheera Ali":
    "Shaheera Ali is a junior in the Daniels School of Business, majoring in Finance and Business Analytics & Information Management. She is currently interning as an Audit & Assurance Technology Controls Discovery Intern at Deloitte. In her free time, she enjoys film theory, kayaking, and exploring new places.",
  "Sandhya Gopinath":
    "Sandhya Gopinath is a Junior in the Daniels School of Business, majoring in Finance and Business Analytics & Information Management. She has previously interned at NextGear Capital by Cox Automotive as a Financial Analyst Intern. In her free time, she enjoys playing table tennis, pickleball, going to the gym and watching thriller shows.",
  "Brock Heller":
    "Brock Heller is a senior in the Daniels School of Business, majoring in Finance. In his free time, he likes to golf, watch college basketball, and travel.",
  "Alex Belanger":
    "Alex Belanger is a senior in the Daniels School of Business, majoring in Finance. He previously interned at Huntington Bank as a Leveraged Finance Intern. In his free time, he enjoys going to the gym, playing chess, and watching football.",
  "Gautham Santhanam":
    "Gautham Santhanam is a junior in the Daniels School of Business, majoring in Finance and Accounting. He has previously interned at Hartford HealthCare as a Finance Intern. In his free time, he enjoys playing tennis, solving Rubik's cubes, and trying new food.",
  "Daniel Friedman":
    "Daniel Friedman is a senior in the Daniels School of Business, majoring in Finance and Accounting. He previously interned at Allied Solutions as a Financial Reporting & Acquisitions Intern. In his free time, he enjoys golfing, visiting national parks, and learning about history.",
  "Cooper Weiss":
    "Cooper Weiss is a junior in the Daniels School of Business, majoring in Finance and Business Analytics & Information Management. Outside of SMIF, he has previously interned at Ivy Wealth Partners as a Financial Advisor. In his free time, he enjoys golf, playing and teaching tennis, and weightlifting.",
  "Ayden Wong":
    "Ayden Wong is a rising senior in the Daniels School of Business, majoring in Business Analytics & Information Management and Finance. Outside of SMIF, he previously interned at Accenture as a Strategy & Consulting Intern. In his free time, he enjoys running, traveling, and reading up on financial markets.",
  "Karanvir Singh":
    "Karanvir Singh is a sophomore in the Daniels School of Business, majoring in Quantitative Economics with concentrations in International Business and Leadership. He has previously interned at Elanco as a Financial Analyst and currently works with the Center for Asia Leadership. In his free time, he enjoys spending time outdoors and playing basketball.",
  "Veer Sanyal":
    "Veer Sanyal is a junior in the Daniels School of Business, majoring in Integrated Business and Engineering. Outside of SMIF, he is currently working as a consulting extern with Scouting America through the Daniels Summer Externship Program. In his free time, he enjoys making origami, weightlifting, and photography.",
  "Anushka Patel":
    "Anushka Patel is a sophomore in the Daniels School of Business at Purdue University, pursuing a B.S. in Quantitative Business Economics and a B.A. in Global Studies with a certification in Data Science. She currently serves as a Portfolio Management Associate with the Student Managed Investment Fund and as a Senior Consultant with 180 Degrees Consulting. Outside of academics, she enjoys art, vintage and thrifted fashion, and public speaking.",
  "Abhipsa Prajapati":
    "Abhipsa Prajapati is a sophomore in the Daniels School of Business, majoring in Mathematics and Quantitative Economics with a minor in Political Science. She is currently conducting AI and finance research through the Wharton AI Research Fellowship at the University of Pennsylvania and previously worked as a Private Credit Analyst. Outside of SMIF, she serves as Corporate Partnership Chair for Women in Consulting and is an Equity Research Analyst with Investment and Trading at Purdue. In her free time, she enjoys bouldering, playing tennis, golfing, and sailing.",
  "Hunter Specht":
    "Hunter Specht is a senior at Purdue University, majoring in Computer Science, Data Science, Applied Statistics, and Finance. He previously interned at MFS Investment Management as a Software Engineering Intern. In his free time, he enjoys playing chess, coding, and going to the gym.",
  "Fabian Segura Vargas":
    "Fabian Segura Vargas is a junior in the Daniels School of Business, majoring in Finance and Business Analytics & Information Management (BAIM). He previously interned at Cummins as a Finance Systems Intern. In his free time, he enjoys playing and watching sports, and filmmaking.",
  "Riley Collins":
    "Riley Collins is a junior in the Daniels School of Business, majoring in Finance and Business Analytics & Information Management. He previously interned at AeroVironment as a Program Manager. In his free time, he enjoys watching basketball, hiking, and golfing.",
};
...
const SECONDARY_BIO_BY_NAME: Record<string, string> = {
  "Keren Wadhwani":
    "Covers interest rates on the Fixed Income & Macro team, tracking Fed policy and the yield curve that frame the fund's macro view.",
  "Andrew Lacambra":
    "Leads the Fixed Income & Macro team, framing the rates, credit, FX, and macro backdrop that informs the fund's equity positioning.",
  "Hunter Specht":
    "Leads the Portfolio + Risk Management team, overseeing allocation, position sizing, risk monitoring, and performance attribution.",
  "Sandhya Gopinath":
...
export const board: Member[] = [
  {
    ...
    role: "Co-President",
    year: "Class of 2027",
    email: "alacambr@purdue.edu",
    photo: andrewLacambraPhoto,
    bio: BIO_BY_NAME["Andrew Lacambra"],
  },
  {
    name: "Ian Teh",
    role: "Co-President",
    year: "Class of 2027",
    email: "iteh@purdue.edu",
    photo: ianTehPhoto,
    bio: BIO_BY_NAME["Ian Teh"],
  },
  {
    name: "Hunter Specht",
    role: "Co-CIO & Co-Head of Education",
    year: "Class of 2027",
    email: "hspecht@purdue.edu",
    photo: hunterSpechtPhoto,
    bio: BIO_BY_NAME["Hunter Specht"],
  },
  {
    name: "Sandhya Gopinath",
    role: "Co-CIO & Co-Head of Education",
    year: "Class of 2028",
    email: "gopinas@purdue.edu",
    photo: sandhyaGopinathPhoto,
    bio: BIO_BY_NAME["Sandhya Gopinath"],
  },
  {
    name: "Keren Wadhwani",
    role: "Treasurer and Director of Fundraising",
    year: "Class of 2028",
    email: "kwadhwan@purdue.edu",
    photo: kerenWadhwaniPhoto,
    bio: BIO_BY_NAME["Keren Wadhwani"],
  },
  {
    name: "Chris Andreou",
    role: "Director of Talent and Operations",
    year: "Class of 2028",
    email: "andreou@purdue.edu",
    photo: chrisAndreouPhoto,
    bio: BIO_BY_NAME["Chris Andreou"],
  },
  {
    name: "Shaheera Ali",
    role: "Director of Marketing and Outreach",
    year: "Class of 2028",
    email: "ali251@purdue.edu",
    photo: shaheeraAliPhoto,
    bio: BIO_BY_NAME["Shaheera Ali"],
  },
];
...
const make = (team: string, members: Entry[]): Member[] =>
  members.map(([name, role, email, gradYear]) => ({
    ...
    bio:
      BIO_BY_NAME[name] && !BOARD_NAMES.has(name)
        ? BIO_BY_NAME[name]
...
board.forEach((m, i) => {
  board[i] = attachLinkedIn(m);
});
fixedIncomeMacro.forEach((m, i) => {
  fixedIncomeMacro[i] = attachLinkedIn(m);
});
portfolioManagers.forEach((m, i) => {
  portfolioManagers[i] = attachLinkedIn(m);
});
sectorTeams.forEach((t) => {
  t.members.forEach((m, i) => {
    t.members[i] = attachLinkedIn(m);
  });
});
